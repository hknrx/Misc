...
// Shader from: https://www.shadertoy.com/view/Ms2GWd
...
void main () {
	...
	vec3 fragColor = vec3 (0.1, 0.2, 0.2 + 0.3 * max (0.0, dot (-direction, lightDirection)));
	if (dist < DELTA) {
	...
	gl_FragColor = vec4 (fragColor * colorMonitor, 1.0);
}
