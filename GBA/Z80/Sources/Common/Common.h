...
// Math
#define FIXED_POINT_ 8 // Doit etre a 8 (valeur interne a la GBA)
#define FIXED_POINT  (1<<FIXED_POINT)
...
extern unsigned char* cpcMemory;
unsigned short cpcScreen;
