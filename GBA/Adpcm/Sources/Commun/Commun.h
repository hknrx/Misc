...
// Math
#define VIRGULE_ 8 // Doit etre a 8 (valeur interne a la GBA)
#define VIRGULE  (1<<VIRGULE_)

#define SINNB_ 8
#define SINNB  (1<<SINNB_)
#define PI     3.14159265359
#define SIN(a) SINUS[(a)&(SINNB-1)]
#define COS(a) SINUS[((a)+(SINNB/4))&(SINNB-1)]
#define SQRT2  1.41421356237

#define INVNB        (4*VIRGULE)
#define INV(n)       ((n)>0?INVERSE[(n)]:-INVERSE[-(n)])
#define VIRGULE_INV_ 15
#define VIRGULE_INV  (1<<VIRGULE_INV_)
