/*
** Mister Jelly - Sources\Common\Common.h
...
////////////////
#include <stdlib.h>
#include "GBAccelerometer\GBAccelerometer.h"
...
#define SIN(a)      commonSineTable[(a)&(SINNB-1)]
#define COS(a)      commonSineTable[((a)+(SINNB/4))&(SINNB-1)]
#define SQRT_SHIFT  4
#define SQRTNB      (256<<(FIXED_POINT_SHIFT-SQRT_SHIFT))
#define SQRT(n)     (commonSqrtTable[(n)>>SQRT_SHIFT]<<((FIXED_POINT_SHIFT+SQRT_SHIFT)/2))
...
// Variables globales //
////////////////////////
volatile unsigned short commonVblCounter;
extern signed short* commonSineTable;
extern unsigned short* commonSqrtTable;
extern CommonSprite* commonSprites;
...
signed long CODE_IN_IWRAM CommonSqrt(signed long x);
